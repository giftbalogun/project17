...
public class Phy111_score extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rs.setText("Your Test 1 score for Phy111 is: " + com.revise.project17.Year2018.Test1.Phy111.Phy111Q.score);
        rp = (Button) findViewById(R.id.replay);

        rp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                com.revise.project17.Year2018.Test1.Phy111.Phy111Q.score = 0;
