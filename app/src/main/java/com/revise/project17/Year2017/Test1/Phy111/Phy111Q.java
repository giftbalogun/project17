package com.revise.project17.Year2017.Test1.Phy111;
...
import com.revise.project17.Year2018.Test1.Phy111.Phy111QR;
import com.revise.project17.Year2018.Test1.Phy111.Phy111_score;

public class Phy111Q extends AppCompatActivity {
    MediaPlayer bgs;
    Phy111QR qst;
    Button btnext;
    TextView qs;
    ...
    public void playNext(View v) {
        ...
        i++;
        if(i>=questions.size()){
            Intent in = new Intent(getApplicationContext(),Phy111_score.class);
            startActivity(in);
            finish();
        }
        if (i < questions.size())
    ...
    class QuizService extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            try {
                qst       = new Phy111QR(params[0], params[1]);
