...
public class Mat111_score extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rs.setText("Your Test 1 score for Mat111 is: "+ com.revise.project17.Year2018.Test1.Mat111.Mat111Q.score);
        rp =(Button) findViewById(R.id.replay);

        rp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                com.revise.project17.Year2018.Test1.Mat111.Mat111Q.score=0;
