package com.revise.project17.Year2017.Test1.Mat112;
...
import com.revise.project17.Year2018.Test1.Mat112.Mat112QR;
import com.revise.project17.Year2018.Test1.Mat112.Mat112_score;

public class Mat112Q extends AppCompatActivity {
    MediaPlayer bgs;
    Mat112QR qst;
    Button btnext;
    TextView qs;
    ...
    public void playNext(View v) {
        ...
        i++;
        if(i>=questions.size()){
            Intent in = new Intent(getApplicationContext(),Mat112_score.class);
            startActivity(in);
            finish();
        }
        if (i < questions.size())
    ...
    class QuizService extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            try {
                qst       = new Mat112QR(params[0], params[1]);
