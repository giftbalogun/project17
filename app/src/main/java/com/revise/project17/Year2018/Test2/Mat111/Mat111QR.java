package com.revise.project17.Year2018.Test2.Mat111;
...
public class Mat111QR {Vector<String> questions = new Vector();
    Vector<String> options   = new Vector();
    Vector<String> answers   = new Vector();

    public Mat111QR(String url, String category) throws Exception{
